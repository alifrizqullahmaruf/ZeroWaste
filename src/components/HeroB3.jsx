...
const HeroB3 = () => {
  return (
    <section className='flex flex-col items-center w-full px-4 py-20 bg-[#EDF7F5] md:px-8'>
      <div className='container mx-auto flex flex-col md:flex-row items-center max-w-[1240px]'>
        ...
        <div className='w-full text-center md:text-left md:w-1/2' data-aos="fade-left">
          ...
          <p className='text-[#132322]' style={{ fontFamily: 'Montserrat', fontSize: '18px', fontStyle: 'italic', fontWeight: '500', lineHeight: '24px' }}>
