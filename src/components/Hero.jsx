...
const Hero = () => {
  return (
    <section className='w-full py-20 pt-32 bg-white'>
      <div className='container mx-auto flex flex-col md:flex-row items-center max-w-[1240px] px-4'>
        <div className='w-full text-center md:w-1/2 md:text-left'>
          ...
          <p className='text-[#132322] mb-6' style={{ fontFamily: 'Montserrat', fontSize: '18px', fontStyle: 'italic', fontWeight: '500', lineHeight: '28px' }}>
